...
class SatisFatura extends AbstractEFatura
{
    ...
    public function createXml($record)
    {
        ...
        $source_id = isset($record['AccountingSupplierParty']['Party']['PartyIdentification']['ID']) ? $record['AccountingSupplierParty']['Party']['PartyIdentification']['ID'] : custom_abort_("VKN bununamadı");//'2687290527';
        $documentIdPrefix = isset($record['IdPrefix']) ? $record['IdPrefix'] : custom_abort_("Fatura ID'si bulunamadı");//'TES2022';
